...
function processPayment(cardNumber, amount) {
    if (cardNumber && amount) {
        ...
        return "Payment of " + amount + "€ with success !";
    }
    return "verify your credit card number/ enter a valid amount.";
}
...
function removeItemFromInventory(itemId) {
    ...
    displayInventory();
    displayResult("Article shipped to customer !");
    updateCodeBlock();
}
...
function updateInventory() {
    if (paymentProcessed) {
        ...
        return "Inventory could not be updated without payment.";
    }
}
...
function handleGoogleSignIn() {
    ...
    googleUserName = " Google user (exemple)";
